...
static const int64 nTargetTimespanDigi = 585; // 9 minutes (NUM_ALGOS * 45 seconds)
static const int64 nTargetSpacingDigi = 585; // 9 minutes (NUM_ALGOS * 45 seconds)
...
unsigned int ComputeMinWork(unsigned int nBase, int64 nTime)
{
    ...
    */
    return Params().ProofOfWorkLimit(ALGO_SHA).GetCompact();
}
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if (!pfrom->fInbound)
        {
            ...
            addrFrom.SetPort(Params().GetDefaultPort());
            pfrom->addr = addrFrom;
...
CBlockTemplate* CreateNewBlock(CReserveKey& reservekey, int algo)
{
    ...
    switch (algo)
    {
        ...
        case ALGO_SCRYPT:
           ...
           break;
        case ALGO_NIST5:
           pblock->nVersion = BLOCK_VERSION_NIST5;
           break;
        case ALGO_GROESTLE:
          pblock->nVersion = BLOCK_VERSION_GROESTLE;
          break;
        case ALGO_PENTABLAKE:
           pblock->nVersion = BLOCK_VERSION_PENTABLAKE;
           break;
        case ALGO_WHIRLPOOL:
           pblock->nVersion = BLOCK_VERSION_WHIRLPOOL;
           break;
        case ALGO_LUFFA:
           pblock->nVersion = BLOCK_VERSION_LUFFA;
           break;
        case ALGO_KECCAK:
        ...
        case ALGO_QUARK:
           ...
           break;
        case ALGO_BASTION:
           pblock->nVersion = BLOCK_VERSION_BASTION;
           break;
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    loop 
    {
        ...
        auto_ptr<CBlockTemplate> pblocktemplate(CreateNewBlock(reservekey, ALGO_SHA));
        if (!pblocktemplate.get())
            return;
...
void static ThreadBitcoinMiner(CWallet *pwallet)
{
    ...
    try 
    {
        ...
        case ALGO_SCRYPT:
           ...
           break;
        case ALGO_NIST5:
           GenericMiner(pwallet, ALGO_NIST5);
           break;
        case ALGO_GROESTLE:
          GenericMiner(pwallet, ALGO_GROESTLE);
          break;
        case ALGO_PENTABLAKE:
           GenericMiner(pwallet, ALGO_PENTABLAKE);
           break;
        case ALGO_WHIRLPOOL:
           GenericMiner(pwallet, ALGO_WHIRLPOOL);
           break;
        case ALGO_LUFFA:
           GenericMiner(pwallet, ALGO_LUFFA);
           break;
        case ALGO_KECCAK:
           GenericMiner(pwallet, ALGO_KECCAK);
           break;
        case ALGO_QUARK:
           GenericMiner(pwallet, ALGO_QUARK);
           break;
        case ALGO_BASTION:
           GenericMiner(pwallet, ALGO_BASTION);
           break;
