...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Joincoin " + FormatFullVersion();
...
// hidden service seeds
 static const char *strNetOnionSeed[][1] = {
     {"63gqkxxae7r2g6dy.onion"},
     {"3o2mhw35ksxoo6pq.onion"},
     {NULL}
  };
...
{
    static const char *(*strOnionSeed)[1] = strNetOnionSeed;
    int found = 0;
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Joincoin is probably already running."), addrBind.ToString().c_str());
        else
